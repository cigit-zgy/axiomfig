...
Both `gallery/sans/` and `gallery/serif/` contain the exact 33 family-organized PDF/PNG pairs exposed by `templates/index.yaml`. `gallery/technical/latex/` contains `scientific_typography` and `palettes` as Tectonic-native pairs. This is 68 pairs and 136 committed Gallery artifacts in total.
